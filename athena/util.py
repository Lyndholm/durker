...
class Utility:
    ...
    def ReadFile(self, filename: str, extension: str, directory: str = "athena/"):
        """
...
class ImageUtil:
    ...
    def Open(self, filename: str, directory: str = "athena/assets/images/"):
    ...
    def Font(
        ...
        directory: str = "athena/assets/fonts/",
    ):
