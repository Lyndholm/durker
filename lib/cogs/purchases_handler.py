...
class PurchasesHandler(Cog):
    ...
    async def why_command(self, ctx):
        ...
        embeds.append(Embed(
            ...
            'статистика покупок **всех** пользователей была сброшена в связи '
            'с появлением новых правил засчитывания покупок, а также изменением '
